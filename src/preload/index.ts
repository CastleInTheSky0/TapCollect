...
const api: CollectorApi = {
  ...
  getTaskGroups: () => ipcRenderer.invoke(IPC_CHANNELS.getTaskGroups),
  createTaskGroup: (name) => ipcRenderer.invoke(IPC_CHANNELS.createTaskGroup, name),
  renameTaskGroup: (id, name) => ipcRenderer.invoke(IPC_CHANNELS.renameTaskGroup, id, name),
  deleteTaskGroup: (id, destination) => ipcRenderer.invoke(IPC_CHANNELS.deleteTaskGroup, id, destination),
  moveTasksToGroup: (ids, destination) => ipcRenderer.invoke(IPC_CHANNELS.moveTasksToGroup, ids, destination),
  saveNewTask: (task, groupId) => ipcRenderer.invoke(IPC_CHANNELS.saveNewTask, task, groupId),
  ...
  openVerification: (taskId, id) => ipcRenderer.invoke(IPC_CHANNELS.openVerification, taskId, id),
  confirmVerification: (taskId, id) => ipcRenderer.invoke(IPC_CHANNELS.confirmVerification, taskId, id),
