export const IPC_CHANNELS = {
  ...
  getTaskGroups: 'task-groups:get',
  createTaskGroup: 'task-groups:create',
  renameTaskGroup: 'task-groups:rename',
  deleteTaskGroup: 'task-groups:delete',
  moveTasksToGroup: 'task-groups:move-tasks',
  saveNewTask: 'tasks:save-new',
  loadTask: 'tasks:load',
  saveTask: 'tasks:save',
